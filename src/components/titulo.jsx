...
const Titulo = ({ data }) => {
    return (
        <div className=" absolute z-40 top-[35%] md:top-[15%] left-[50%] md:left-1/4 -translate-x-1/2 md:translate-x-0 w-[70%] md:max-w-[400px] flex flex-col items-center md:items-start text-left md:text-left gap-4 md:gap-6">
