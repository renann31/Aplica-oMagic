        ...
        >
            ...
            <div className="flex-col">
                ...
                <div className="px-3 py-2 flex gap-4">
                    <a 
                        href="https://wa.me/553499783854?text=Olá%20quero%20um%20orçamento"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="w-8 h-8 flex items-center justify-center rounded-full border border-[#F2C94C] text-[#F2C94C]">
                        <FaWhatsapp size={20} />
                    </a>

                    <a 
                        href="https://instagram.com/magiceventosbr" 
                        target="_blank" 
                        rel="noopener noreferrer" className="w-8 h-8 flex items-center justify-center rounded-full border border-[#F2C94C] text-[#F2C94C]">
                        <FaInstagram size={20} />
                    </a>
                </div>
            </div>
